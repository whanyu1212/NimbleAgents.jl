...
# Sessions &amp; Artifacts {#Sessions-and-Artifacts}

## Sessions {#Sessions}

A [`Session`](/reference#NimbleAgents.Session) manages conversation state across multiple interactions with an agent.
...
An [`Artifact`](/reference#NimbleAgents.Artifact) is a named, typed output produced by an agent — files, plots, data exports, reports.
...
### Automatic Artifact Registration {#Automatic-Artifact-Registration}
