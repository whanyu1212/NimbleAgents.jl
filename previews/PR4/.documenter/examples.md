...
### Agent-as-Tool + Handoff Pipeline {#Agent-as-Tool-Handoff-Pipeline}
...
### Claude Code as a Sub-Agent {#Claude-Code-as-a-Sub-Agent}
...
### Pattern 1: `should_interrupt` (Recommended) {#Pattern-1:-should_interrupt-Recommended}
...
### Pattern 2: `after_llm_call` Hook {#Pattern-2:-after_llm_call-Hook}
...
### Pattern 3: `approval_channel` (Async) {#Pattern-3:-approval_channel-Async}
...
### Built-in Tool Library {#Built-in-Tool-Library}
...
## Tracing &amp; Cost Tracking {#Tracing-and-Cost-Tracking}
