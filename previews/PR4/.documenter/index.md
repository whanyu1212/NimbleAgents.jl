...
## Why NimbleAgents? {#Why-NimbleAgents?}
...
## Why Julia for agents? {#Why-Julia-for-agents?}
...
Ready to get started? Check out the [Getting Started](/getting_started#Getting-Started) guide.
</div>
