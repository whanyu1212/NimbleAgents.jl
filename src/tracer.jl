...
function Trace(turns::Vector{TurnEvent})
    ...
    Trace(turns, total_in, total_out, total_in + total_out, total_cost,
          total_llm, total_tool, duration, agents)
end
...
function print_trace(trace::Trace; io::IO=stdout)
    ...
    println(io, "  Tokens     : $(trace.total_input_tokens) in / " *
