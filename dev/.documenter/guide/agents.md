...
The [`Agent`](/reference#NimbleAgents.Agent) struct is the core of NimbleAgents. It encapsulates an AI assistant with a specific role, tools, and behavior.
...
### Structured Output Parse Retries {#Structured-Output-Parse-Retries}
...
Rate limiting is especially useful with [`fan_out`](/reference#NimbleAgents.fan_out-Tuple{Agent,%20Vector{String}}), [`spawn_subagents`](/reference#NimbleAgents.spawn_subagents-Tuple{Vector{<:Tuple{Agent,%20String}}}), and the web server, where many agents may call the same model concurrently.
...
### Built-in Model Pricing {#Built-in-Model-Pricing}
...
## Extended Thinking &amp; Reasoning {#Extended-Thinking-and-Reasoning}
...
### OpenAI Reasoning (works today) {#OpenAI-Reasoning-works-today}
...
### Other api_kwargs Uses {#Other-api_kwargs-Uses}
...
### Anthropic Extended Thinking (limited support) {#Anthropic-Extended-Thinking-limited-support}
...
::: tip Why GeminiOpenAISchema exists
